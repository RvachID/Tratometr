            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-2 text-start d-none" id="m-alice-item-wrap">
                            <label class="form-label" for="m-alice-item">Товар</label>
                            <select id="m-alice-item" class="form-select">
                                <option value="">Выбрать из списка покупок...</option>
                            </select>
                            <small class="text-muted">
                                После сохранения выбранный товар отметится купленным.
                            </small>
                        </div>
