    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body">
            ...
            <p class="text-muted small mb-2">
                <strong>Я считаю траты ещё до кассы.</strong><br>

                Сканируй ценники или вводи вручную. Контроль в моменте, а не по чекам.
               Сразу покажу стоимость текущей корзины и предупрежу о превышении лимита.
            </p>
